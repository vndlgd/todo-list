...
function createProject(title) {
  ...
  _index__WEBPACK_IMPORTED_MODULE_0__.projectsArray.push(todoListData);
...
function createTodo(
  ...
  const projectContainingTask = _index__WEBPACK_IMPORTED_MODULE_0__.projectsArray.find(
...
/* harmony export */   todoNameExists: () => (/* binding */ todoNameExists)
/* harmony export */ });
...
const projectsArray = []; // stores all todo-lists created and its todo items
...
function todoNameExists(taskName) {
  let exists = false;
...
const general = (0,_create_project_js__WEBPACK_IMPORTED_MODULE_2__.createProject)('General');
// saveProjectToLocalStorage(); // save General to local storage upon refresh

const controller = (0,_view_js__WEBPACK_IMPORTED_MODULE_3__.displayController)();
  ...
  window.addEventListener('load', (e) => {
    ...
    if (localStorage.getItem('projects') !== null) {
      ...
      for (let i = 0; i < projectStorage.length; i++) {
        if (projectStorage[i] !== 'General') {
          (0,_create_project_js__WEBPACK_IMPORTED_MODULE_2__.createProject)(projectStorage[i]);
        }
      }
    }
    ...
    if (localStorage.getItem('todos') !== null) {
      ...
      for (let i = 0; i < todoStorage.length; i++) {
        (0,_create_todo_js__WEBPACK_IMPORTED_MODULE_1__.createTodo)(
          todoStorage[i].title,
...
function saveProjectToLocalStorage() {
  ...
  if (storageArray.length === 0) {
    _index__WEBPACK_IMPORTED_MODULE_0__.projectsArray.forEach((list) => {
      storageArray.push(list.title);
    });
    localStorage.setItem('projects', JSON.stringify(storageArray));
  } else {
    const titleArray = _index__WEBPACK_IMPORTED_MODULE_0__.projectsArray.map(({ title }) => title);
...
function displayController() {
  ...
  function newTaskModal() {
    ...
    function openTaskDialog() {
      ...
      _index__WEBPACK_IMPORTED_MODULE_2__.projectsArray.forEach((list) => {
    ...
    function saveTask() {
      ...
      if (taskTitle.value === '') {
      ...
      } else if ((0,_index__WEBPACK_IMPORTED_MODULE_2__.todoNameExists)(taskTitle.value)) {
        ...
        (0,_localStorage__WEBPACK_IMPORTED_MODULE_3__.saveTaskToLocalStorage)();
  ...
  function newProjectModal() {
    ...
    function saveProject() {
      const titleArray = _index__WEBPACK_IMPORTED_MODULE_2__.projectsArray.map(({ title }) => title);
      if (inputEl.value === '') {
        alert('Please add title.');
      } else if (titleArray.includes(inputEl.value)) {
        alert('That title already exists.');
      } else {
        (0,_create_project__WEBPACK_IMPORTED_MODULE_0__.createProject)(inputEl.value);
        (0,_localStorage__WEBPACK_IMPORTED_MODULE_3__.saveProjectToLocalStorage)();
        renderSubmenu();
        // updateProjectHeader();
        console.log(_index__WEBPACK_IMPORTED_MODULE_2__.projectsArray);
    ...
    function deleteProject(project) {
      _index__WEBPACK_IMPORTED_MODULE_2__.projectsArray.forEach((list) => {
        if (list.title === project) {
          (0,_localStorage__WEBPACK_IMPORTED_MODULE_3__.removeProjectFromLocalStorage)(project);
          (0,_index__WEBPACK_IMPORTED_MODULE_2__.deleteTodoList)(project);
          renderSubmenu();
      ...
      if (list.title === projectList) {
        ...
        list.todos.forEach((todo, index) => {
          if (todo.title === taskTitle) {
            ...
            (0,_localStorage__WEBPACK_IMPORTED_MODULE_3__.removeTaskFromLocalStorage)(todo.title);
          }
        });
      }
    });
  ...
  function renderSubmenu() {
    ...
    _index__WEBPACK_IMPORTED_MODULE_2__.projectsArray.forEach((project) => {
      const container = document.createElement('div');
      const newProject = document.createElement('button');
      const image = document.createElement('img');
      image.src = _icon_png__WEBPACK_IMPORTED_MODULE_4__;
  ...
  function renderPage(menuOption) {
    ...
    const sevenDaysFromNow = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(), 1), 'yyyy-MM-dd');

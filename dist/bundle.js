...
function TodoItem(
  ...
  function updateDueDate() {
    ...
    dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(prompt('Due Date (MM/DD/YYYY): ')), 'MM/dd/yy');
    if (dueDate === '') {
      dueDate = Date.now();
    }

...
function displayController() {
  ...
  const newTaskModal = function () {
    ...
    saveBtn.addEventListener('click', (e) => {
      ...
      if (taskTitle.value === '') {
        ...
        (0,_todo_app__WEBPACK_IMPORTED_MODULE_2__.saveTaskToLocalStorage)();
  ...
  function createTask(
    ...
    saveTaskEdit.addEventListener('click', (e) => {
      e.preventDefault();
      const projectContainingTask = _todo_app__WEBPACK_IMPORTED_MODULE_2__.projects.find(
